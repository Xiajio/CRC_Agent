...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"nested": {"promptText": "system prompt"}},
        {"system": {"prompt": "system prompt"}},
        {"nested": {"model_prompt": "system prompt"}},
        {"hidden": {"reasoning": "private"}},
        {"nested": {"hiddenReasoning": "private reasoning"}},
        {"chain": {"ofThought": "private"}},
        {"nested": {"chainOfThought": "private reasoning"}},
        {"patients": [{"id": "MRN-1"}]},
        {"patient": {"id": "MRN-123"}},
        {"nested": {"patientIds": ["MRN-123"]}},
        {"nested": {"patient_mrns": ["MRN-1"]}},
        {"nested": {"patientMRNs": ["MRN-1"]}},
        {"nested": {"patientNames": ["A"]}},
        {"nested": {"patientNumbers": ["N-1"]}},
