...
# 确保 CLAM_Tool 根目录在 PYTHONPATH 中，避免子进程找不到 models 包
CLAM_TOOL_DIR = os.path.abspath(os.path.dirname(__file__))
...
parser.add_argument('--config_file', type=str, default="./heatmap/config/heatmap_config.yaml")
